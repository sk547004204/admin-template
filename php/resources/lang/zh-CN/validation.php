...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | 下面的语言包含Validator类默认的错误消息，请随意调整这些消息中的每一条。
    |
    */
    ...
    'date_equals'          => '日期 :attribute 和 :format 不一致。',
    ...
    'lt'                   => [
        ...
        'array'   => ':attribute 必须小于 :value 单元',
    ],
    'lte'                  => [
        'numeric' => ':attribute 必须小于等于 :value。',
        'file'    => ':attribute 必须小于等于 :value kb。',
        'string'  => ':attribute 必须小于等于 :value 字符。',
        'array'   => ':attribute 必须小于等于 :value 单元',
    ],
    'max'                  => [
